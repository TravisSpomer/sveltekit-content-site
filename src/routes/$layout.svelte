...
:root
{
	...
	--primary-dark1: #3378c8;
	--primary-dark2: #1753b9;
	--primary-dark3: #223fa4;
	--primary-dark4: #2d297f;
...
{
	@return ceil(100000 * $line-height / $font-size) / 100000;
}
...
kbd
{
	...
	border-width: 1px;
	border-color: var(--grey-light1);
	background-image: linear-gradient(to bottom, transparent, var(--grey-light2));
	border-radius: .2em;
